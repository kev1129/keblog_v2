...
なお、Central Asia Travel では衣類以外のアックスやクランポン、ブーツといった基本的なギアのレンタルサービス利用可能。
...
| アイテム         | ポイント・メモ                                               | 使用ギア                                                     |
| ---------------- | ------------------------------------------------------------ | ------------------------------------------------------------ |
| 登山靴           | ダブルが主流。条件の良い日にアタックすればシングルでも可     | [LOWA Alpine Expert](https://www.iwatani-primus.co.jp/products/lowa/items/L210022/) |
| ダウンジャケット | 強風対応でエクスペディション用を推奨<br />サミットプッシュ0時発の際に重宝 | [TNF Himalayan Parka](https://goods.kojitusanso.jp/goods/ND91921_HB/) |
| サングラス       | 透光率10％以下が安心                                         | [KOHLA Himalayan](https://www.yodobashi.com/product/100000001004582502/) |
| テント           | 軽量・4シーズン用を1張、全てのキャンプで常設利用可           | [TNF Assault 2](https://www.goldwin.co.jp/ap/item/i/m/NV22506?srsltid=AfmBOor2Fp8j1TqKytaZVkxDlz200ra2Vc7K2OF0QPwGAeIEIRz9_z7T) |
| 寝袋             | −20℃対応で十分                                               | [Sea to Summit Alpine II](https://www.lostarrow.co.jp/store/g/gST81371001/) |
| 手袋             | 厚手＋薄手を組み合わせて調整                                 | [BD Soloist](https://www.lostarrow.co.jp/store/g/gBD73080001005/) |
| マット           | 停滞時の快適性重視。2枚持ち多し、1枚だけで後悔               | —                                                            |
...
| アイテム  | ポイント・メモ                                               |
| --------- | ------------------------------------------------------------ |
| ロープ    | 単独でも短いロープがあれば同じソロクライマーとロープアップ可能 |
| アックス  | C1–C2の急傾斜用。ストレートでOK                              |
| FIX用装備 | ハーネス、アッセンダー、ディッセンダー、スリング、カラビナなど |
| ストック  | クレバスチェックにも使える                                   |
| ビーコン  | 持たない人も多く、GerminGPSを使う人も。判断は自己責任        |
...
| アイテム | ポイント                                       | 使用ギア                                             |
| -------- | ---------------------------------------------- | ---------------------------------------------------- |
| ストーブ | 融雪効率重視                                   | [MSR WindBurner](https://e-mot.co.jp/product/36219/) |
| ガス缶   | BCで購入可（小缶10USD）                        |                                                      |
| ライター | 火打石＋マッチ推奨。プッシュ式は故障多し       |                                                      |
| 地図     | ノーマルルートなら必須ではない                 |                                                      |
| デポ袋   | 土嚢袋が用途広く便利                           |                                                      |
| サプリ   | マルチビタミン＋ミネラル                       |                                                      |
| 薬類     | ダイアモックス、葛根湯、ロキソニン、血行促進剤 |                                                      |
...
この保険には、以下の2種類があり、標高と期間によって価格が設定されています。
